...
const Detalle: NextPage = () => {
    ...
    const {data, isLoading, isPreviousData, isError} = trpc.degreeWork.getOne.useQuery({id: postId}, {keepPreviousData: true})
    if(isLoading) return <div>Loading...</div>
    if (isError && !data) return <Error statusCode={404} />
    return(
